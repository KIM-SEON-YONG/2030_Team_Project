					...
					.ajax({
						...
						success : function(dataList) {
							...
							if (dataList.length === 0) {
								// 이미지 요소 생성 및 클래스 추가
								var noBenefitImg = $('<img>').attr('src',
										'images/policy_noBenefit.png').attr(
										'alt', '해당 지역에는 복지혜택이 없습니다.').addClass(
										'noBenefit');
										...
										.each(
												...
												function(index, policy) {
													...
													console
															.log(
																	"welfare_title:",
																	policy.welfare_title);
													console
															.log(
																	"welfare_period:",
																	policy.welfare_period);
													console
															.log(
																	"welfare_content:",
																	policy.welfare_content);
													...
													link
															.append($('<span>')
																	.addClass(
																			'welfare_sort welfare_sort_job')
																	.html('취업'));
													link
															.append($('<p>')
																	.addClass(
																			'welfare_title welfare_title_job')
																	.text(
																			policy.welfare_title));
													link
															.append($('<p>')
																	.addClass(
																			'welfare_period welfare_period_job')
																	.text(
																			policy.welfare_period));
													link
															.append($('<p>')
																	.addClass(
																			'welfare_content welfare_content_job')
																	.text(
																			policy.welfare_content));
